...
export class WebrtcConn {
  ...
  constructor(signalingConn, initiator, remotePeerId, room) {
    console.log("establishing connection to ", logging.BOLD, remotePeerId);
     ...
     * @type {any}
     */
    console.log("{ initiator, ...room.provider.peerOpts }", {
      initiator,
      ...room.provider.peerOpts,
    });
    this.peer = new Peer({ initiator, ...room.provider.peerOpts });
    this.peer.on("signal", (signal) => {
      console.log("publishSignalingMessage", signalingConn, room, {
        to: remotePeerId,
        from: room.peerId,
        type: "signal",
        signal,
...
export class WebrtcProvider extends Observable {
  ...
  constructor(
    ...
    this.key.then((key) => {
      ...
      console.log(
        "this.room and this.shouldConnect",
        this.room,
        this.shouldConnect
      );
  ...
  connect() {
    ...
    console.log("this.signalingUrls:", this.signalingUrls);
